                 ...
                 {activeMenu === 'View' && (
                    <>
                        ...
                        <div className="absolute top-full left-0 mt-2 w-56 bg-[#2B2B2B] rounded-lg shadow-2xl z-50 overflow-hidden flex flex-col py-2 animate-in fade-in zoom-in-95 duration-100 ring-1 ring-white/5">
                            ...
                            {/* Focus Mode */}
                            <button 
                                onClick={() => { onToggleFocusMode(); setActiveMenu(null); }}
                                disabled={!canFocusMode}
                                className="text-left px-4 py-2.5 text-[13px] text-[#E3E3E3] hover:bg-[#3d3d3d] transition-colors flex items-center justify-between group disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                <div className="flex items-center gap-3">
                      ...
                      <>
                          ...
                          <div className="absolute top-full left-0 mt-2 w-56 bg-[#2B2B2B] rounded-lg shadow-2xl z-50 overflow-hidden flex flex-col py-2 animate-in fade-in zoom-in-95 duration-100 ring-1 ring-white/5">
                              ...
                              <button 
                                  ...
                                  className="text-left px-4 py-2.5 text-[13px] text-[#E3E3E3] hover:bg-[#3d3d3d] transition-colors flex items-center gap-3"
                              >
                                  <span className="material-symbols-rounded text-[18px] text-md-sys-primary">keyboard</span>
                                  Keyboard Shortcuts
                                  <span className="ml-auto text-[10px] text-gray-500 border border-gray-600 rounded px-1">?</span>
                              </button>
                              <button 
