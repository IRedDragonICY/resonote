...
export const TermsModal: React.FC<TermsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-md-sys-surface rounded-[28px] p-0 shadow-2xl max-w-2xl w-full animate-in zoom-in-95 duration-200 flex flex-col ring-1 ring-md-sys-outline/20 max-h-[85vh]">
          
          {/* Header */}
          <div className="p-6 border-b border-md-sys-outline/10 flex items-center gap-4">
              ...
              <div>
                  <h2 className="text-xl font-bold text-md-sys-onSurface">Terms of Service</h2>
                  <p className="text-sm text-md-sys-secondary">Last updated: May 2024</p>
              </div>
          </div>

          {/* Content */}
          <div className="p-6 overflow-y-auto custom-scrollbar text-sm text-md-sys-secondary leading-relaxed space-y-4">
              <p>Welcome to Resonote. By accessing or using our application, you agree to be bound by these Terms of Service.</p>
              
              <h3 className="text-md-sys-onSurface font-semibold pt-2">1. Service Description</h3>
              ...
              <h3 className="text-md-sys-onSurface font-semibold pt-2">2. Accuracy and Liability</h3>
              ...
              <h3 className="text-md-sys-onSurface font-semibold pt-2">3. User Conduct & Content</h3>
              ...
              <h3 className="text-md-sys-onSurface font-semibold pt-2">4. Data Usage</h3>
              ...
              <h3 className="text-md-sys-onSurface font-semibold pt-2">5. Intellectual Property</h3>
          ...
          {/* Footer */}
          <div className="p-6 border-t border-md-sys-outline/10 flex justify-end">
              <button 
                  onClick={onClose}
                  className="px-8 py-2.5 bg-md-sys-primary text-md-sys-onPrimary rounded-full text-sm font-semibold hover:opacity-90 transition-opacity"
              >
                  I Understand
              </button>
          </div>
