...
export const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="bg-md-sys-surface rounded-[28px] p-8 shadow-2xl max-w-md w-full flex flex-col items-center animate-in zoom-in-95 duration-200 ring-1 ring-md-sys-outline/20">
        ...
        <h2 className="text-2xl font-bold text-md-sys-onSurface mb-1 tracking-tight">Resonote</h2>
        <p className="text-xs font-mono text-md-sys-primary mb-6 bg-md-sys-primary/10 px-2 py-1 rounded">v1.0.0 Public Preview</p>
        
        <p className="text-sm text-md-sys-secondary text-center leading-relaxed mb-8 px-2">
            Resonote is an advanced AI-powered sheet music digitizer. 
            Leveraging the multimodal capabilities of <strong className="text-md-sys-onSurface">Gemini 3 Pro</strong>, 
        ...
        <div className="w-full bg-md-sys-surfaceVariant/30 rounded-xl p-4 mb-8 flex items-center gap-4 border border-md-sys-outline/10">
            ...
            <div className="flex-1">
                ...
                <p className="text-sm text-md-sys-onSurface font-medium">IRedDragonICY</p>
                <p className="text-[10px] text-md-sys-outline">Mohammad Farid Hendianto</p>
            </div>
        </div>

        <button 
            onClick={onClose}
            className="w-full py-3 bg-md-sys-primary text-md-sys-onPrimary rounded-full font-semibold hover:opacity-90 transition-opacity"
        >
            Close
        </button>
      </div>
